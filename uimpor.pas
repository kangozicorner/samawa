...
uses
  ...
  fpsallformats, JvSpecialProgress, bgraExKnobs, TplProgressBarUnit,DateUtils;
...
begin
  wb := TsWorkbook.Create;
  f := ExtractFilePath(Application.ExeName) + 'newbook.xls';
