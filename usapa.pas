...
type
  ...
  private
    ...
    const VERSI = '0.7.4.003 [25 Mei 2022]';
  public
    MUST_UPDATE : String;
    procedure CekUpdate;
...
begin
  OpenURL('http://sites.google.com/view/kangozcorner/home');
end;
...
var
     ...
     p:TStringList;
begin
                  //https://drive.google.com/file/d/19Icc9Dh-jRdJ-M7PFgrHdFJ2GrB8xrC6/view?usp=sharing
  versi_server := 'https://drive.google.com/uc?export=download&id=19Icc9Dh-jRdJ-M7PFgrHdFJ2GrB8xrC6';
